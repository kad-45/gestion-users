 ...
 */
final class Version20221122155617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD job_id INT DEFAULT NULL, ADD profile_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne DROP job_id, DROP profile_id');
    }
}
