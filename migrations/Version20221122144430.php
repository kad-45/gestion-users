 ...
 */
final class Version20221122144430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job DROP designation');
        $this->addSql('ALTER TABLE personne ADD profile_id INT DEFAULT NULL, ADD job_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personne_hobies (personne_id INT NOT NULL, hobies_id INT NOT NULL, INDEX IDX_7DD284A68AF36D36 (hobies_id), INDEX IDX_7DD284A6A21BD112 (personne_id), PRIMARY KEY(personne_id, hobies_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE job ADD designation VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE personne DROP profile_id, DROP job_id');
    }
}
